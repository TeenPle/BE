package com.shu.backend.domain.usersetting.exception.status;
...
@Getter
@AllArgsConstructor
public enum UserSettingSuccessStatus implements BaseCode {
    // Auth
    ...
    USERSETTING_READ_SUCCESS(HttpStatus.OK, "USERSETTING2000", "로그인한 유저의 설정 정보 조회 완료");
