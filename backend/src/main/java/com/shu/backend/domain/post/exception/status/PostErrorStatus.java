...
public enum PostErrorStatus implements BaseErrorCode {
    ...
    BLOCKED_AUTHOR(HttpStatus.FORBIDDEN, "POST4030", "차단한 사용자의 게시글입니다."),
    NO_PERMISSION_TO_ACCESS(HttpStatus.FORBIDDEN, "POST4031", "No permission to access this content.");
